<?php
	...
	if ( isset( $_POST['rt_reading_time_hidden'] ) && 'Y' == $_POST['rt_reading_time_hidden'] ) {
		...
		//Normal page display
		$readingTimeLabel            = $rt_reading_time_options['label'];
		$readingTimePostfix          = $rt_reading_time_options['postfix'];
		$readingTimePostfixSingular  = $rt_reading_time_options['postfix_singular'];
		$readingTimeWPM              = $rt_reading_time_options['wpm'];
		$readingTimeCheck            = $rt_reading_time_options['before_content'];
		$readingTimeCheckExcerpt     = $rt_reading_time_options['before_excerpt'];
